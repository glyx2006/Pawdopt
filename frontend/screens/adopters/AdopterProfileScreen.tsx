...
const AdopterProfileScreen: React.FC = () => {
  ...
  const [preferences, setPreferences] = useState<Preferences>(initialPreferencesState);
  ...
  const fetchAllData = useCallback(async () => {
    ...
    try {
      ...
      // Fetch preferences after fetching the profile
  ...
  const handleEditPreferences = () => {
    navigation.navigate('EditAdopterPreference');
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.infoSection}>
          ...
          <Text style={styles.infoText}><Text style={styles.infoLabel}>Age Range:</Text> {preferences.minAge || 'Any'} - {preferences.maxAge || 'Any'} years</Text>
          <Text style={styles.infoText}><Text style={styles.infoLabel}>Size:</Text> {preferences.size.join(', ') || 'Any'}</Text>
          <Text style={styles.infoText}><Text style={styles.infoLabel}>Color:</Text> {preferences.color.join(', ') || 'Any'}</Text>
          <Text style={styles.infoText}><Text style={styles.infoLabel}>Breeds:</Text> {preferences.preferredBreeds.join(', ') || 'Any'}</Text>
        </View>
